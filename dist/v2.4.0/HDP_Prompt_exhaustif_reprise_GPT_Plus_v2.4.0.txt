# Prompt autonome de reconstruction — Humanitarian Data Platform 2.4.0
...
Tu reprends la maintenance et la livraison de **Humanitarian Data Platform (HDP) 2.4.0**, application locale Windows 10/11 x64. Ton objectif est de retrouver fidèlement l’état fonctionnel, documentaire et distribuable décrit ci-dessous, puis de poursuivre le projet sans régression et sans inventer de validation.
...
message `feat: add verified COD family downloads v2.4.0`. Si `main` a
...
3. lire `dist/v2.4.0/MANIFESTE_HumanitarianDataPlatform_v2.4.0.txt` et `dist/v2.4.0/SHA256SUMS.txt` ;
...
Une exécution v1.5 a été validée sur Windows 11 avec Docker Desktop, WSL 2 et le port 18080. Cette recette historique ne doit pas être présentée comme une recette automatique de la v2.4.0.
...
- diagnostic produit : `Bureau\HDP_Debug_v2.4.0_*.log`.
...
source/
  build.sh
  HDP_Diagnostic_v2.4.0.cmd
  HDP_Configurer_GitHub_v2.4.0.cmd
  HumanitarianDataPlatform_Setup_README_v2.4.0.txt
  payload/
    CHANGELOG_HDP.log
  ...
  tests/test_v24_helpers.py
tools/generate_notice_v240.py
```

### 20. Livrables v2.4.0 et empreintes
...
- `HumanitarianDataPlatform_Setup_Native_GUI_v2.4.0.exe.sha256` ;
- `HumanitarianDataPlatform_Windows_v2.4.0.zip` ;
- `HumanitarianDataPlatform_Source_v2.4.0.zip` ;
- `HumanitarianDataPlatform_Archive_complete_v2.4.0.zip` ;
- `HumanitarianDataPlatform_Archive_complete_v2.4.0.zip.sha256` ;
- `HumanitarianDataPlatform_Setup_README_v2.4.0.txt` ;
- `CHANGELOG_HDP_v2.4.0.log` ;
- `HDP_Configurer_GitHub_v2.4.0.cmd` ;
- `HDP_Diagnostic_v2.4.0.cmd` ;
- `Notice_detaillee_Humanitarian_Data_Platform_v2.4.0.pdf` ;
- `HDP_Prompt_exhaustif_reprise_GPT_Plus_v2.4.0.txt` ;
- `MANIFESTE_HumanitarianDataPlatform_v2.4.0.txt` ;
- `SHA256SUMS.txt`.
...
```text
EXE
7ed5df7e81b05cf6f5cd614074c045e22f6f6205505fcab5631bb72f60a6d296

ZIP Windows
e15cdc8a3fac718771bdb19fdced01be11d38f00e15a26de72be8a1177bf8dfc

ZIP sources
49b99ed733f4b8bfa5c50731a1be1ac0e2c46043c96a3204e0267cb33aa9f007

Archive complète
Voir HumanitarianDataPlatform_Archive_complete_v2.4.0.zip.sha256 : son empreinte
ne peut pas être auto-incluse dans le prompt que contient cette même archive.

Notice PDF
38b16ff3600f31b9076ea6f9b8b49803ce46fea32f0fd97aa6dc2e5a4c8ad949
```
...
### 21. Validations réellement effectuées pour la v2.4.0

Les validations disponibles sont :

- compilation syntaxique des modules Python ;
- 29 tests unitaires réussis ;
...
- interrogation directe du catalogue HDX : 166 candidats bruts COD-AB et 148
  COD-PS ; 163/146 canoniques et 143 dans l'intersection ;
- Soudan retenu dans les deux familles avec 1 GeoJSON COD-AB et 13 ressources
  CSV/XLSX COD-PS ; Algérie absente de l'intersection car COD-PS manque ;
- PDF de 22 pages rendu en PNG et inspecté visuellement ;
- arbre GitHub distant relu après publication.

Le moteur Docker était absent de l’environnement Linux de construction. Par conséquent, ne prétends pas que les éléments suivants ont été validés pour la v2.4.0 :
...
Ce prompt décrit l’état de livraison v2.4.0 ; les archives historiques 2.3.2 et antérieures restent inchangées.
