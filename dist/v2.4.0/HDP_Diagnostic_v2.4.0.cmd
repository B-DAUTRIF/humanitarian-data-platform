...
set "HDP_LOG=%HDP_DESKTOP%\HDP_Debug_v2.4.0_%HDP_STAMP%.log"
set "HDP_APP=%USERPROFILE%\HumanitarianDataPlatform"
set "HDP_INSTALLER_LOGS=%LOCALAPPDATA%\HumanitarianDataPlatform\logs"
set "HDP_RUN_CWD=%CD%"

call :log "Humanitarian Data Platform 2.4.0 - diagnostic borne"
...
if exist "%HDP_APP%\compose.yaml" (
  ...
  >>"%HDP_LOG%" echo.
  >>"%HDP_LOG%" echo [Dossiers de donnees HDP 2.4.0]
