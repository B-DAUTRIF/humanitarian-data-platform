...
class IterationOneStaticContractTest(unittest.TestCase):
    ...
    def test_interface_exposes_both_configuration_scopes_and_library_filters(self) -> None:
        ...
        self.assertIn("version 5.0.1", self.html_text)
    ...
    def test_windows_build_metadata_targets_version_501(self) -> None:
        self.assertIn('#define APP_VERSION L"5.0.1"', self.installer_text)
        self.assertIn("HumanitarianDataPlatform_Setup_Native_GUI_v5.0.1.exe", BUILD_PATH.read_text(encoding="utf-8"))
        resources = RESOURCE_PATH.read_text(encoding="utf-8")
        self.assertIn("FILEVERSION 5,0,1,0", resources)
        self.assertIn('VALUE "ProductVersion", "5.0.1"', resources)
    ...
    def test_windows_upgrade_preserves_unknown_environment_lines(self) -> None:
        ...
        self.assertIn(".env.backup-before-v5.0.1", self.installer_text)
