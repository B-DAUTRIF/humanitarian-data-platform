...
class IterationOneStaticContractTest(unittest.TestCase):
    ...
    def test_interface_exposes_both_configuration_scopes_and_library_filters(self) -> None:
        ...
        self.assertIn("version finale 3.0.0", self.html_text)
    ...
    def test_windows_build_metadata_targets_version_300(self) -> None:
        self.assertIn('#define APP_VERSION L"3.0.0"', self.installer_text)
        self.assertIn("HumanitarianDataPlatform_Setup_Native_GUI_v3.0.0.exe", BUILD_PATH.read_text(encoding="utf-8"))
        resources = RESOURCE_PATH.read_text(encoding="utf-8")
        self.assertIn("FILEVERSION 3,0,0,0", resources)
        self.assertIn('VALUE "ProductVersion", "3.0.0"', resources)
    ...
    def test_windows_upgrade_preserves_unknown_environment_lines(self) -> None:
        ...
        self.assertIn(".env.backup-before-v3.0.0", self.installer_text)
