# Construction de l'installateur 2.4.0
...
4. produit `HumanitarianDataPlatform_Setup_Native_GUI_v2.4.0.exe`.

Le test `tests/payload_roundtrip.c` valide que le tableau embarqué restitue exactement le payload. Les tests Python de `tests/test_v24_helpers.py` couvrent les chemins confinés, URL publiques, noms de fichiers, empreintes, intervalles, paramètres GitHub, ONU M49, familles COD officielles et leur intersection.
