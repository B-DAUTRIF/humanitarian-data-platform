...
set "HDP_LOG=%HDP_DESKTOP%\HDP_Debug_v3.0.0_%HDP_STAMP%.log"
set "HDP_APP=%USERPROFILE%\HumanitarianDataPlatform"
set "HDP_INSTALLER_LOGS=%LOCALAPPDATA%\HumanitarianDataPlatform\logs"
set "HDP_RUN_CWD=%CD%"

call :log "Humanitarian Data Platform 3.0.0 - diagnostic borne"
...
if exist "%HDP_APP%\compose.yaml" (
  ...
  >>"%HDP_LOG%" echo.
  >>"%HDP_LOG%" echo [Dossiers de donnees HDP 3.0.0]
