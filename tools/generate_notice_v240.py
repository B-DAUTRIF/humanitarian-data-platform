...
OUTPUT = ROOT / "output" / "pdf" / "Notice_detaillee_Humanitarian_Data_Platform_v2.4.0.pdf"
PAGE_W, PAGE_H = A4
...
PAGES: list[tuple[str, str, list[tuple[str, str]]]] = [
    (
        ...
        [
            ...
            ("h2", "Objet"),
            ("body", "HDP acquiert des métadonnées humanitaires publiques, conserve leur provenance et télécharge des ressources dans des espaces séparés par projet. La version 2.4.0 expose les familles COD officielles sous forme de liste et limite la zone aux pays ou zones communs à ONU M49 et HDX."),
    ...
    (
        ...
        "Ce que fournit la version 2.4.0",
        [
            ("lead", "Les fonctions 2.3.2 sont conservées ; COD-AB et COD-PS deviennent des téléchargements officiels sélectionnables dans un même profil."),
            ...
            ("bullet", "Géographie : liste ONU M49 × HDX, COD-AB/COD-PS, format géospatial COD-AB et ressources tabulaires COD-PS."),
            ("bullet", "Transparence : COD-CS est visible mais désactivé avec un registre vérifié vide ; COD-HP est signalé comme retiré."),
            ("bullet", "Cohérence : tout changement de familles, pays, politique ou format invalide l'ancien statut et demande une nouvelle synchronisation."),
    ...
    (
        ...
        "Parcours recommandé",
        [
            ("bullet", "Décompresser HumanitarianDataPlatform_Windows_v2.4.0.zip."),
    ...
    (
        ...
        "ONU M49 et familles COD OCHA/HDX",
        [
            ("body", "L'utilisateur choisit COD-AB et/ou COD-PS, puis un pays ou une zone dans l'intersection des groupes HDX canoniques et de la nomenclature ONU M49."),
            ("bullet", "La saisie libre d'un identifiant HDX est supprimée de ce module."),
            ("bullet", "COD-AB exige cod-ab-<iso3>, cod-enhanced ou cod-standard et choisit le format géospatial demandé."),
            ("bullet", "COD-PS exige cod-ps-<iso3> ou sa série officielle et choisit les ressources CSV/XLSX."),
            ("bullet", "Le 7 août 2026 : 163 pays/zones COD-AB, 146 COD-PS et 143 options communes."),
            ("bullet", "COD-CS reste désactivé avec un registre vérifié vide ; COD-HP est retiré et non sélectionnable."),
    ...
    (
        ...
        "Autorité statistique et correspondance HDX",
        [
            ...
            ("body", "Les groupements M49 sont destinés aux statistiques et n'impliquent aucune position politique de HDP. L'interface 2.4.0 n'expose comme zone que les pays ou zones ISO3 présents dans toutes les familles choisies."),
        ],
    ),
    (
        ...
        [
            ("body", "Synchroniser maintenant enregistre les familles et le pays M49, interroge leurs catalogues officiels puis lance les téléchargements. Le mode automatique rend le profil immédiatement éligible."),
            ...
            ("bullet", "Si une famille manque, les réponses sont archivées mais aucun sous-ensemble n'est téléchargé."),
    ...
    (
        ...
        [
            ...
            ("body", "L'acquisition et sa provenance restent conservées après suppression. Pour un COD, la ligne conserve famille, M49, ISO3, niveau publié, éditeur, licence et date des métadonnées HDX."),
        ],
    ),
    (
    ...
    (
        ...
        "Mise à niveau idempotente depuis 1.5, 2.0 ou 2.3.x",
        [
            ...
            ("bullet", "Un ancien profil pays est conservé avec COD-AB ; monde/région sont suspendus jusqu'au choix dans la liste commune."),
            ("bullet", "cod_families et cod_family sont ajoutés sans supprimer ni réécrire les anciennes ressources."),
    ...
    (
        ...
        [
            ("body", "HDP_Diagnostic_v2.4.0.cmd crée HDP_Debug_v2.4.0_*.log sur le Bureau et limite chaque commande externe à 15 secondes."),
    ...
    (
        ...
        [
            ("bullet", "Compilation Python et 29 tests unitaires de sécurité, planification, M49 et sélection COD officielle."),
            ("bullet", "Recette HDX réelle : 163 COD-AB, 146 COD-PS, intersection 143, Soudan commun et Algérie COD-AB seul."),
    ...
    (
        "19. Livrables",
        "Contenu du dossier dist/v2.4.0",
        [
            ("bullet", "HumanitarianDataPlatform_Setup_Native_GUI_v2.4.0.exe et son empreinte."),
            ("bullet", "HumanitarianDataPlatform_Windows_v2.4.0.zip pour l'utilisateur Windows."),
            ("bullet", "HumanitarianDataPlatform_Source_v2.4.0.zip pour la reconstruction."),
            ("bullet", "HumanitarianDataPlatform_Archive_complete_v2.4.0.zip pour la remise complète."),
            ("bullet", "Notice, README court, diagnostic, manifeste, prompt de reprise et SHA256SUMS.txt."),
            ("body", "Les livrables 2.3.2 et antérieurs restent dans leurs dossiers dédiés et ne sont pas modifiés."),
        ],
    ),
    (
        ...
        [
            ...
            ("bullet", "Tester COD-AB seul puis COD-AB + COD-PS et vérifier les compteurs et l'intersection."),
            ("bullet", "Tester Soudan commun, l'absence d'Algérie avec COD-PS, le report, la provenance et le SHA-256."),
    ...
    (
        ...
        [
            ...
            ("bullet", "OCHA CODs et COD-CS : knowledge.base.unocha.org — Common Operational Datasets"),
            ("bullet", "CKAN Action API : docs.ckan.org/en/latest/api"),
            ("bullet", "ReliefWeb API V2 : apidoc.reliefweb.int"),
            ("body", "Commencez le dépannage par HDP_Diagnostic_v2.4.0.cmd, puis fournissez le journal relu, le statut Docker, la version Windows et l'étape exacte en échec. Ne communiquez jamais .env ni un jeton GitHub."),
            ("body", "Fin de la notice · Humanitarian Data Platform 2.4.0"),
        ],
    ),
]
...
def header(c: canvas.Canvas, page_number: int, title: str, subtitle: str) -> float:
    ...
    c.setFillColor(CYAN)
    c.drawRightString(PAGE_W - 16 * mm, PAGE_H - 13 * mm, "HDP 2.4.0")
    return PAGE_H - 59 * mm
...
def footer(c: canvas.Canvas, page_number: int) -> None:
    ...
    c.drawString(16 * mm, 10 * mm, "Humanitarian Data Platform 2.4.0 · notice détaillée")
...
def build() -> None:
    ...
    c.setTitle("Notice détaillée Humanitarian Data Platform 2.4.0")
    c.setAuthor("Humanitarian Data Platform")
    c.setSubject("Installation, GitHub, ONU M49, COD-AB/COD-PS officiels et sécurité")
    for page_number, (title, subtitle, blocks) in enumerate(PAGES):
        ...
        if page_number == 0:
            ...
            c.setFillColor(BLUE)
            c.drawString(25 * mm, y - 14 * mm, "VERSION DE REMISE · 2.4.0")
            c.setFont(FONT, 8.5)
            c.setFillColor(MUTED)
            c.drawString(25 * mm, y - 21 * mm, "Dépôt GitHub · ONU M49 × HDX · COD-AB/COD-PS officiels")
            y -= 35 * mm
