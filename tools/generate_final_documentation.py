#!/usr/bin/env python3
"""Génère la documentation consolidée HTML et PDF de HDP 3.0.0."""
...
DOCS = [
    ...
    ("Cahier des charges", ROOT / "docs/CAHIER_DES_CHARGES_V3.0.0.md"),
    ("Guide utilisateur", ROOT / "docs/USER_GUIDE.md"),
    ("Installation", ROOT / "docs/INSTALLATION.md"),
    ("Architecture", ROOT / "docs/ARCHITECTURE.md"),
    ("Référence API", ROOT / "docs/API_REFERENCE_V3.0.0.md"),
    ("Passerelle GitHub", ROOT / "docs/GITHUB_API.md"),
    ("Migration depuis 2.5.0", ROOT / "docs/MIGRATION_V2.md"),
    ("Sécurité", ROOT / "docs/SECURITY.md"),
    ("Développement", ROOT / "docs/DEVELOPMENT.md"),
    ("Dépannage", ROOT / "docs/TROUBLESHOOTING.md"),
    ("Livrables", ROOT / "docs/ARTIFACTS.md"),
    ("Historique", ROOT / "CHANGELOG.md"),
]

OUT_HTML = ROOT / "docs/Documentation_Humanitarian_Data_Platform_v3.0.0.html"
OUT_PDF = ROOT / "docs/Notice_detaillee_Humanitarian_Data_Platform_v3.0.0.pdf"
...
<title>Humanitarian Data Platform 3.0.0 — Documentation finale</title>
<style>
...
<header><div class="kicker">Documentation de référence</div><h1>Humanitarian Data Platform</h1><p>Version finale 3.0.0 — spécifications, installation, architecture, API, sécurité, exploitation et livrables.</p><p>Édition du 15 août 2026</p></header>
<main><nav><strong>Sommaire</strong><ol>{nav}</ol></nav><article>{''.join(sections)}</article></main>
<footer>Humanitarian Data Platform 3.0.0 — documentation finale consolidée</footer></body></html>"""
...
def build_pdf() -> None:
    ...
    def decorate(canvas, document) -> None:
        ...
        canvas.drawString(20 * mm, 11 * mm, "Humanitarian Data Platform 3.0.0 — documentation finale")
        canvas.drawRightString(width - 20 * mm, 11 * mm, f"Page {document.page}")
        canvas.restoreState()

    doc = SimpleDocTemplate(str(OUT_PDF), pagesize=A4, leftMargin=20 * mm, rightMargin=20 * mm, topMargin=20 * mm, bottomMargin=18 * mm, title="Humanitarian Data Platform 3.0.0 — Documentation finale", author="Humanitarian Data Platform")
    story: list = [Spacer(1, 46 * mm), Paragraph("DOCUMENTATION DE RÉFÉRENCE", styles["CoverKicker"]), Paragraph("Humanitarian<br/>Data Platform", styles["CoverTitle"]), Paragraph("Version finale 3.0.0", styles["CoverSub"]), Spacer(1, 12 * mm), Paragraph("Spécifications · installation · architecture · API · sécurité · exploitation · livrables", styles["CoverSub"]), Spacer(1, 26 * mm), Paragraph("Édition du 15 août 2026", styles["CoverSub"]), PageBreak(), Paragraph("Sommaire", styles["PartFinal"])]
