...
def cycle5() -> Cycle:
    ...
    checks.append(require("len(codes) != 1" in dhs_service and "mapping is not uniquely verified" in dhs_service, "DHS ambiguous or missing distinct provider-code mapping fails closed while duplicate identical rows are tolerated"))
