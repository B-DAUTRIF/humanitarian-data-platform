...
OUTPUT = ROOT / "output" / "pdf" / "Notice_detaillee_Humanitarian_Data_Platform_v2.3.1.pdf"
PAGE_W, PAGE_H = A4
...
PAGES: list[tuple[str, str, list[tuple[str, str]]]] = [
    (
        ...
        [
            ...
            ("h2", "Objet"),
            ("body", "HDP acquiert des métadonnées humanitaires publiques, conserve leur provenance et télécharge des ressources dans des espaces séparés par projet. La version 2.3.1 limite le module géographique à ONU M49 et aux COD-AB officiels OCHA/HDX."),
    ...
    (
        ...
        "Ce que fournit la version 2.3.1",
        [
            ("lead", "Les fonctions 2.3.0 sont conservées ; le périmètre géographique devient normé, traçable et fermé aux jeux arbitraires."),
    ...
    (
        ...
        "Parcours recommandé",
        [
            ("bullet", "Décompresser HumanitarianDataPlatform_Windows_v2.3.1.zip."),
    ...
    (
        ...
        [
            ("body", "L'utilisateur choisit un élément hiérarchique ONU M49. HDP développe un groupement vers ses pays ou zones descendants, puis cherche uniquement la série COD - Subnational Administrative Boundaries."),
            ("bullet", "La saisie libre d'un identifiant HDX est supprimée de ce module."),
            ("bullet", "Chaque jeu doit porter la série officielle, un niveau cod-enhanced ou cod-standard et un groupe ISO3 M49."),
    ...
    (
        ...
        [
            ("body", "HDP_Diagnostic_v2.3.1.cmd crée HDP_Debug_v2.3.1_*.log sur le Bureau et limite chaque commande externe à 15 secondes."),
    ...
    (
        ...
        [
            ("bullet", "Compilation Python et 21 tests unitaires de sécurité, planification, M49 et sélection COD officielle."),
    ...
    (
        "19. Livrables",
        "Contenu du dossier dist/v2.3.1",
        [
            ("bullet", "HumanitarianDataPlatform_Setup_Native_GUI_v2.3.1.exe et son empreinte."),
            ("bullet", "HumanitarianDataPlatform_Windows_v2.3.1.zip pour l'utilisateur Windows."),
            ("bullet", "HumanitarianDataPlatform_Source_v2.3.1.zip pour la reconstruction."),
            ("bullet", "HumanitarianDataPlatform_Archive_complete_v2.3.1.zip pour la remise complète."),
    ...
    (
        ...
        [
            ...
            ("body", "Commencez le dépannage par HDP_Diagnostic_v2.3.1.cmd, puis fournissez le journal relu, le statut Docker, la version Windows et l'étape exacte en échec. Ne communiquez jamais .env ni un jeton GitHub."),
            ("body", "Fin de la notice · Humanitarian Data Platform 2.3.1"),
        ],
    ),
]
...
def header(c: canvas.Canvas, page_number: int, title: str, subtitle: str) -> float:
    ...
    c.setFillColor(CYAN)
    c.drawRightString(PAGE_W - 16 * mm, PAGE_H - 13 * mm, "HDP 2.3.1")
    return PAGE_H - 59 * mm
...
def footer(c: canvas.Canvas, page_number: int) -> None:
    ...
    c.drawString(16 * mm, 10 * mm, "Humanitarian Data Platform 2.3.1 · notice détaillée")
...
def build() -> None:
    ...
    c.setTitle("Notice détaillée Humanitarian Data Platform 2.3.1")
    ...
    for page_number, (title, subtitle, blocks) in enumerate(PAGES):
        ...
        if page_number == 0:
            ...
            c.setFillColor(BLUE)
            c.drawString(25 * mm, y - 14 * mm, "VERSION DE REMISE · 2.3.1")
            c.setFont(FONT, 8.5)
            c.setFillColor(MUTED)
