...
```powershell
Get-FileHash .\HumanitarianDataPlatform_Setup_Native_GUI_v5.0.0.exe -Algorithm SHA256
Get-Content .\HumanitarianDataPlatform_Setup_Native_GUI_v5.0.0.exe.sha256
```
