...
| Actions automatiques contrôlées | Partiel avancé / travailleurs internes vérifiés | travailleur d'actions et travaux de données vérifiés sur PostgreSQL 16 ; vue opérateur candidate pour décisions, tentatives, brouillons et résultats par source ; 266 tests recensés localement | exécuter la nouvelle recette d'observabilité, qualifier les appels connecteurs réels et les exécuteurs externes séparés |
