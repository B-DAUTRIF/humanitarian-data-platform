...
| Installation, raccourci et désinstallation | Réalisé dans le code / non qualifié | Shell Link COM natif ; désinstallation marquée, fichiers exacts, `compose down` sans volumes, données et tiers conservés | compilation MSVC puis recette Windows avec chemins Unicode/espaces, arrêt Docker et reprise après échec |
