...
| Actions automatiques contrôlées | Partiel avancé / travailleur interne vérifié | travailleur PostgreSQL, bail et reprise, annulation transactionnelle, nouvelle vérification des quotas, approbation explicite, effets internes idempotents, brouillons et audit ; 257/257 tests dont sept recettes réelles PostgreSQL 16 | traiter réellement `automated_data_jobs`, qualifier l'interface et les exécuteurs externes séparés |
