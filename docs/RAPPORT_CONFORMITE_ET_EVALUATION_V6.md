...
| Actions automatiques contrôlées | Partiel avancé / recette distante requise | travailleur PostgreSQL, bail et reprise, annulation transactionnelle, nouvelle vérification des quotas, approbation explicite, effets internes idempotents, brouillons et audit | exécuter les sept tests PostgreSQL, traiter réellement `automated_data_jobs`, qualifier l'interface et les exécuteurs externes séparés |
