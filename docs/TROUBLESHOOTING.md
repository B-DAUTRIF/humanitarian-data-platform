...
| Création GitHub indisponible | `GITHUB_TOKEN` absent ou conteneur API créé avant la modification de `.env` | Double-cliquer sur [`HDP_Configurer_GitHub_v3.0.0.cmd`](../source/HDP_Configurer_GitHub_v3.0.0.cmd), saisir le jeton dans l'invite masquée et attendre la vérification |
...
Le fichier [`HDP_Configurer_GitHub_v3.0.0.cmd`](../source/HDP_Configurer_GitHub_v3.0.0.cmd) applique la procédure complète sous Windows :
